  ...
  return (
    ...
    >
      <div className="relative -z-10 max-w-screen w-full min-h-[250px] md:min-h-[520px] mx-auto flex pt-5 items-center justify-center flex-col bg-image overflow-y-hidden backdrop-blur-sm bg-gradient-to-b from-transparent to-black/20 rounded-2xl shadow-2xl">
        ...
        >
          <span className="text-white block font-normal text-3xl md:text-2xl text-center font-monteseret-regular mb-3 md:mb-5 uppercase tracking-[0.2em] text-glow">
            Welcome to{" "}
          </span>
          ANICOMIC STUDIO
          <br />
        ...
        <div className="relative flex max-w-lg w-full justify-center gap-8 mt-8 z-30">
          <motion.span
            initial={{ scale: 0.2 }}
            animate={{ scale: 1 }}
