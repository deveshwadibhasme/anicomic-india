...
const Homepage = () => {
  return (
    <div className="relative z-20 max-w-screen w-full min-h-[200px] md:min-h-[440px] mx-auto flex pt-3 items-center justify-center flex-col bg-image overflow-y-hidden 2xl:scale-130">
      <motion.h1
